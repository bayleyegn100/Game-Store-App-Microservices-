...
//            tempCon = consoleFeignClient.getConsoleById(invoiceViewModel.getItemId());
            Optional<Console> returnVal = consoleFeignClient.getConsoleById(invoiceViewModel.getItemId());

//            Optional<Console> returnVal = consoleFeignClient.findById(invoiceViewModel.getItemId());
            ...
            Game tempGame = null;
            Optional<Game> returnVal = gameFeignClient.getGameById(invoiceViewModel.getItemId());

//            Optional<Game> returnVal = gameFeignClient.findById(invoiceViewModel.getItemId());
            ...
            Optional<TShirt> returnVal = tShirtFeignClient.getTShirtById(invoiceViewModel.getItemId());
//            Optional<TShirt> returnVal = tShirtFeignClient.findById(invoiceViewModel.getItemId());
        ...
        Optional<ProcessingFee> returnVal2 = processingFeeRepository.findById(invoiceViewModel.getItemType());
