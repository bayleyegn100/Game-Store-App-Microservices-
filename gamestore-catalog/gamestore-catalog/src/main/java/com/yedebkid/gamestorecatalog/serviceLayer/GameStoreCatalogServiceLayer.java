package com.yedebkid.gamestorecatalog.serviceLayer;
...
public class GameStoreCatalogServiceLayer {
    ...
    public ConsoleViewModel createConsole(ConsoleViewModel consoleViewModel) {
        ...
        if (consoleViewModel==null) throw new IllegalArgumentException("No Console is passed! Console object is null!");
    ...
    public TShirtViewModel createTShirt(TShirtViewModel tShirtViewModel) {
        ...
        return buildTShirtViewModel(tShirtRepo.save(tShirt));
    }
